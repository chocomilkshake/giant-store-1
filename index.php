        ...
        <section class="section-margin calc-60px">
            <div class="container">
                ...
                <div id="product-container" class="row">
                    <?php $item->show_product($con, $branch); ?>
                </div>
            </div>
        ...
        <section class="subscribe-position">
            <div class="container">
                <div class="subscribe text-center">
                    <h3 class="subscribe__title">Get Updates From Anywhere</h3>
                    <p>Bearing Void gathering light light his evening unto don’t be afraid</p>
